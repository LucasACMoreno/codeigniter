...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class='content'>
			<div class="container-fluid">
				<h1>[SEGURADORA DO MORENÃO]</h1>
				<h2>Trabalho Engenharia de Software 3 <br> Nome: Lucas Moreno <br> RA: 010617023</h2>
				<h1>Funcionalidades:</h1>
				<p>Cadastrar|Editar|Excluir -> Parentesco<p>
				<p>Cadastrar|Editar|Excluir -> Estado<p>
				<p>Cadastrar|Editar|Excluir -> Benefícios<p>
				<p>Cadastrar|Editar|Excluir -> Cobertura<p>
			</div>
        </div>
    </div>
</div>
